"""
CRS × UserSim 오케스트레이션 스크립트.

build_graph.py 의 app/initial_state/config 와
user_sim.py 의 UserSimAgent/PERSONA_TEMPLATES 를 큐 기반으로 연결합니다.
...
from app.pipeline.graph import app, initial_state, config
