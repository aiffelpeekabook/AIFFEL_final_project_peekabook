...
from app.rag.query_transform_v3 import extract_genre_node, query_transform_rag_node
...
def create_app(chroma_db_path: str = None):
    path = chroma_db_path or os.getenv("CHROMA_DB_PATH", "./chroma_db")
    memory_store = MemoryStore(persist_directory=path)
