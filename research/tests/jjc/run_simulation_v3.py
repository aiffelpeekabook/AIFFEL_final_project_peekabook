"""
CRS × UserSim 오케스트레이션 스크립트 (v3).

2단계 장르 필터 (category_large / category_medium) + query_transform_v3 사용.
...
from app.pipeline.graph_v3 import app, initial_state, config
...
async def main():
    persona = PERSONA_TEMPLATES["직장인_SF팬"]
    thread_id = "eval_session_v3_001"
